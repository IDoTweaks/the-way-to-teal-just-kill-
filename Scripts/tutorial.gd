...
func _ready() -> void:
	...
	phaseData = {
		...
		"Zone6": {"text":"SLAM: jump up, then press CTRL in mid-air to plunge STRAIGHT down - it stops you dead, higher fall = bigger boom", "ab":[true,false,true,false,true,false], "guns":1, "gunLock":0, "gate":"GateSlam", "need":"slam", "ghost":"slam", "done":"BOOM!"},
