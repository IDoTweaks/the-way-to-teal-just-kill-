...
const LIST = [
	...
	{"id": "bloodmoney", "name": "BLOOD MONEY", "desc": "+30% damage while points are high", "tier": RARE, "cap": 4, "needs": {"greedpact": 1}, "special": "greed_dmg"},
	{"id": "compound", "name": "COMPOUND INTEREST", "desc": "+8% damage per 20k points held", "tier": EPIC, "cap": 3, "needs": {"greedpact": 1}, "special": "greed_scale"},
	{"id": "highroller", "name": "HIGH ROLLER", "desc": "+15% move speed while points are high", "tier": RARE, "cap": 3, "needs": {"greedpact": 1}, "special": "greed_speed"},
	{"id": "luckystreak", "name": "LUCKY STREAK", "desc": "+20% crit chance while points are high", "tier": RARE, "cap": 3, "needs": {"greedpact": 1}, "special": "greed_crit"},
	{"id": "dividends", "name": "DIVIDENDS", "desc": "+25% points gained", "tier": COMMON, "cap": 5, "needs": {"greedpact": 1}, "special": "greed_gain"},
	{"id": "offshore", "name": "OFFSHORE ACCOUNT", "desc": "Points bleed 40% slower", "tier": COMMON, "cap": 3, "needs": {"greedpact": 1}, "special": "greed_calm"},
